...
\paragraph{Gifts and professionalism} In many countries, it's customary to give professors gifts, often during holidays.  These gifts can be costly and expected by professors. In the US, it's not a common practice, and it's perfectly acceptable not to give gifts. However, if you'd like to offer small souvenir-like tokens, it's a thoughtful gesture that's appreciated. Professors often display such gifts proudly, and they can come from students, colleagues, or when they travel. In summary, small gifts are fine, but avoid anything that might make your professors uncomfortable.
