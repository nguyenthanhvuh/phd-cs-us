...
%\usepackage{tocloft} % For custom TOC levels
...
\newcommand{\sectioninfo}[1]{%
  \phantomsection
  \addcontentsline{toc}{sectioninfo}{#1}%
}

\newcommand{\subsectioninfo}[1]{%
  \phantomsection
  \addcontentsline{toc}{subsectioninfo}{#1}%
}
...
\chapterinfo{\emph{Publications can greatly help}. Papers in good venues are concrete evidence that you have successfully engaged in research. But they are not required!}
