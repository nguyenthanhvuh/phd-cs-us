...
\paragraph{Red flags in Your Background} Plagiarism, cheating, or other academic dishonesty are red flags. Another one is if you have a history of jumping from one program to another (e.g., you have been in multiple different programs in short time). If you think you have red flags, you should address them in your SOP.
