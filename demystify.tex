...
\subsection*{Admission Committee (adcom)}\label{sec:adcom}
...
\subsubsection{Why CS depts do not waive the application fee?}  
...
\end{commentbox}
\subsection{How are decisions made?}\label{sec:how-decisions}
\subsectioninfo{Even if all adcom reviewers recommend acceptance, the application can still be rejected. Vice versa, if all reviewers think the application is weak, the student might still be admitted.}
...
\subsection{Do adcom members talk to each other?}\label{sec:adcom-discuss}
\subsectioninfo{Sometimes adcom members discuss applicants, but in most cases they make independent decisions.}
...
\subsection{Do adcom members read all applications?}\label{sec:read-all}
\subsectioninfo{Adcom members only review applications assigned to them (typically matching their expertise) and rarely get involved in other applications}
