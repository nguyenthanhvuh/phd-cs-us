...
Many resources are available to encourage and support students from underrepresented and minority (URM) groups to pursue research, e.g., specific scholarships and fellowships. Faculty in CS are also \emph{very} familiar with and are highly encouraged to support URM students in their group. There are also incentives, such as dedicated funding, to motivate faculty to recruit and mentor URM students (\autoref{sec:urm}).
