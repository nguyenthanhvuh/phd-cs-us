...
The document might also not sufficient for students aiming for top-10 schools, which might have different requirements\footnote{e.g., see the \href{https://da-data.blogspot.com/2015/03/reflecting-on-cs-graduate-admissions.html}{admission process} at CMU}.  However, the information here should be useful for students aiming for other good schools, e.g., R1 institutions in the US. It is definitely useful for students aiming for GMU :)
