...
If you have an MS then some course work \emph{might be} transferred for course credits, which saves a bit of time. But don't count on this, especially if your MS is not from the US.
