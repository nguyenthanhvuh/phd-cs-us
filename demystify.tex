...
\newcommand{\chapterinfo}[1]{%
  \phantomsection
  \addcontentsline{toc}{chapterinfo}{\color{black}{\emph{#1}}}%
}
\newcommand{\sectioninfo}[1]{%
  \phantomsection
  \addcontentsline{toc}{sectioninfo}{\color{black}{\emph{#1}}}%
}
\newcommand{\subsectioninfo}[1]{%
  \phantomsection
  \addcontentsline{toc}{subsectioninfo}{\color{black}{\texttt #1}}%
}
...
\chapterinfo{Yes, definitely.  CS PhD study in the US is fully funded and admission into good universities in the US is not any harder than in other countries.}
...
\chapterinfo{Applications are evaluated by the \emph{PhD Admission} (adcom) committee and each application is typically reviewed by three faculty members.}
...
\sectioninfo{Adcom members are faculty who evaluate your application.}
...
\chapterinfo{LORs are very important, but only if they are personalized and talk about your research ability.}
...
\chapterinfo{Publications can greatly help. Papers in good venues are concrete evidence that you have successfully engaged in research. But they are not required!}
...
\chapterinfo{SOP is important. Write it in such a way that makes you \emph{stand out}.}
...
\chapterinfo{Standard tests are not important. GRE typically \emph{is not} required. For standard English tests (not required for domestic students), just do enough to pass the minimum requirements.}
