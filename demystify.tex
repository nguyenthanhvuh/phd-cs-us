...
\mainmatter
\chapter{Should You Apply to a PhD program in CS in the US?}\label{sec:should}
...
\subsection{Tenured, Tenure Track, Teaching,  Assistant Profs., Associate Profs}
...
\section{Difference between PhD in the US and other countries}\label{sec:non-us-differences}
...
\section{How do I address a professor?}\label{sec:address}
