...
\begin{itemize}
    ...
    \item \textbf{Sending the similar mail to multiple profs}. Sending emails to multiple profs. using BCC or even CC (where we can see all addresses the email is being sent to) will result in no reply or a very harsh one on how unprofessional this is.
