...
Many possible reasons!  Other than not having very strong profile (e.g., research potentials, GPA, LoRs, SOP), here are some that you might not expect:
\begin{itemize}
...
For example, in the 2024 admission cycle, there is a huge surge in students who are interested in AI and NLP (thanks, ChatGPT!). However, our AI/NLP faculty cannot take more students and therefore we cannot admit many applicants, many of whom have excellent profiles (e.g., papers in top conferences, strong LoRs, etc.).
