...
\begin{description}
  ...
  \item[NSF] National Science Foundation. A US government agency that supports research and education in science and engineering. NSF is a major source of funding for RAs in CS research. There are other agencies that support RAs but they might require US citizenship or permanent residency.
        \item [R1/R2 Universities] Research 1 (R1) universities are universities with the highest level of research activity. Research 2 (R2) universities have a high level of research activity but not as high as R1 universities.  R1 universities are typically larger, and have more funding and resources for research.  R2 universities are also good but might have fewer resources and funding.
...
\chapterinfo{MS focuses on coursework and prepares you for industry, while PhD focuses on research and prepares you for academia or research labs. This section provides guidance on applying to MS programs.}
...
In an MS application, you typically need to submit the similar materials as in a PhD application, e.g., transcripts, LoRs, SOP, and test scores.  However, research experience is not required, and LoRs can be from anyone who can speak about your academic or working abilities (e.g., professors, employers, etc). Moreover, your SOP you should focus on your academic and work (e.g., software development) background, why you want to get an MS, and how the program fits your goals. As with PhDs, GREs are often not required.  Moreover, some MS programs do not even require LoRs or SOPs.  

\paragraph{Transcripts and Undergrad Background} Since research is not required, your undergrad background is more important in an MS application.  You should have a strong background in CS, e.g., through your undergrad degree.  If you do not have a CS degree, you might need to take some prerequisite courses before you can start the MS program.  GPA is also important, as it is often used as a filter for MS applications.
...
\paragraph{LoRs} LoRs can be from professors, employers, or anyone who can speak about your academic or working abilities.  Unlike PhDs, your LoRs do not need to be from professors and talk about research experience. Many schools do not even require LoRs for MS.

\paragraph{Test Scores} GREs are often not required for MS applications.  However, some schools might still require them, and you should check with the school you're applying to.  If you have a low GPA, a high GRE score can help offset that.
