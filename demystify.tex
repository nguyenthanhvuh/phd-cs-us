  ...
  \item Choosing School and Professors
    ...
    \item Miscs and FAQS
        \begin{itemize}
          ...
          \item Being in the underepresentative groups in CS can help (\autoref{sec:urm}).
...
If you think you have red flags, you should address them in your SOP or ask your letter writers to do so. 
...
In short, you \emph{do not need} to formally taking CS courses, you just need to show that you have these essential knowledge, e.g., through the mentioned ways. Many universities are well-aware that incoming graduate students might not have all the technical background, so they often have a \emph{``bridge''} courses to help students catch up.  For example, GMU has four bridge courses (Data Structures and Algorithms, Computer Systems, Discrete Math, and Programming Foundation) that incoming students can take to catch up on their CS knowledge.
