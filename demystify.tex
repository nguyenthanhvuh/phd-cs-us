...
If a student asks me to write letter for them, I will agree as I believe it is part of my job.  However, I will let them know if I won't be able to write a strong letter for them (e.g., they just take my class and I don't know them well enough), and suggest they find someone else.  If they insist, then I will write the letter. It will be a weak and generic letter though I still try to have something positive, e.g., the student is hardworking, or that I heard they are working on a research project, etc.  Regardless, the letters will still be short and weak (\autoref{sec:generic-letters}) and usually take about 5--10 minutes to write.
