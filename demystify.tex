...
\part{Introduction To CS PhD Admission}\label{part:intro}
...
It is a good idea to upload a writing sample, e.g., a paper you wrote, a report, or a thesis.  Even if the paper is published, not published, or already on Arxiv, you should upload it. Because samples are part of the application package, adcom members can quickly skim through it to see your research and writing abilities.  
...
\part{Types of Funding and Choosing Schools and Profs.}\label{part:funding-schools-profs}
