...
In recent years many universities start requiring a statement about diversity, equity, and inclusion (DEI) as part of the application (also see \autoref{sec:urm}). Students, especially international ones, often wonder what to write about, especially if they are not from a minority group, have not experienced anything related the topic, or even not sure what it is about.
