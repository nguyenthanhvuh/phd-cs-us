...
\begin{itemize}
\item \textbf{Ask in advance} You should ask for LoRs \emph{at least a month} before the deadline. People are busy and writing a strong LoR takes time (\autoref{sec:lor-writing}), so you should give them enough time to write a strong letter for you.
...
\item \textbf{Ask for feedback} If the writer is very close to you, you can ask them for feedback on your application, e.g., your SOP.

\item \textbf{Follow up and Stay in touch} Follow up with your writers to make sure they have submitted the letters on time.  After your writers have submitted all of their letters, \emph{thank them}!  Finally, let them know the outcome of your applications and stay in touch with them.  This will help you build a relationship with them and you might need them to write for you again in the future.
\end{itemize}
