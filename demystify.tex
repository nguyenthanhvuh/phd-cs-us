...
% This section summarizes the main points of this guideline. It also gives you an overview to decide which specific topics you want to explore more thoroughly.
  ...
  %\item Should you apply to a PhD CS program in the US?
    ...
    %       \item
    %       \item
    %       \item (\autoref{sec:msrequirement}), and CS PhD takes abou (\autoref{sec:time}). (\autoref{sec:non-us-differences}).
    %       \item
    %       \item
    %       \item
...
\sectioninfo{Compared to other countries, CS PhD in the US does not require an MS degree but has a longer PhD study time.}
