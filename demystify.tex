...
In recent years many universities start requiring a statement about diversity, equity, and inclusion (DEI) as part of the application (also see \autoref{sec:urm}). This has caused confusion among many applicants, especially international students. They often wonder what to write about, especially if they are not from a minority group, have not experienced anything related the topic, or even not sure what it is about.

A DEI statement is about showing your \emph{awareness of DEI}, your understanding of the challenges others face, and actions you've taken to contribute. Customize what you write to your own background and experiences.  Here are some tips:
...
\item \textbf{Show your awareness, customized to your own experiences}. For example, if you come from a different culture or country, talk about DEI here, e.g., many countries completely lack diversity in CS programs, talk about it, what does minority group face in your country?  How do you think DEI can benefit? 
...
Moreover, do not make up stories or exaggerate your experiences.  Just show your awareness and understanding of the topic and what you did or how you plan to contribute to it (e.g., mentoring students, helping others).  One of the best DEI essay I have read start the acknowledgement that the applicant is not a minority, but a white male in a STEM field (i.e., that make them the majority), and that they do not have much experience in DEI, but show that they are aware of the challenges faced by minority groups and how they can contribute to it.
\end{commentbox}
