...
\begin{enumerate}
  ...
  \item Choosing School and Professors
    ...
    \item Miscs and FAQS
        \begin{itemize}
          \item Why you were rejected (\autoref{sec:why-rejected}). One potential reason is because you're applying to AI/ML, a super competitive field in recent years with many applicants.
          ...
          \item It take about 10 minutes to review an application (\autoref{sec:ievaluate}).
          ...
          \item You do not need an MS degree (\autoref{sec:msrequirement}), and CS PhD takes about 5--7 years (\autoref{sec:time}). Compared to other countries, CS PhD in the US does not require an MS degree but has a longer PhD study time (\autoref{sec:non-us-differences}).
          \item How do you call your professors? In many cases, just by first names! (\autoref{sec:address})
...
\paragraph{How to help your LOR writer} As mentioned above, do not write your own letter. Instead, you can help your LOR writer by providing details or unique things about yourself. For example, let them know about your GPA, research and work experiences, papers (if any), or anything you want them to mention. You can also provide them with a draft of your SOP so that they can see what you are saying about yourself and can complement that with their own perspective.
