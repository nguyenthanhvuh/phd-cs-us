...
PhD applications from Vietnam to US universities is low and more would be very welcomed. 
\end{commentbox}
...
\paragraph{Diversity} US universities prioritize diversity and inclusion. It's crucial for students to respect and appreciate varied opinions, backgrounds, and cultures. Unlike some countries where certain voices are marginalized, in the US, all perspectives are valued equally (especially at universities). Racism or discrimination can have serious consequences, including academic and disciplinary actions.
...
Here is the typically steps: (i) a faculty suspecting a cheating case will report it to the Office of Academic Integrity (OAI) at the university;  (ii)  OAI will completely take over and investigate the case; and finally (iii) OAI make the final decision.  It is important to note that after receiving the report from your prof., OAI completely takes over (so begging your professor will not help because they simply are no longer involved).
