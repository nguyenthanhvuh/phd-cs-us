...
\newtcolorbox{myemphasisbox}{
  ...
  %borderline = {1pt}{0pt}{blue!75!black},
...
\part{Introduction To CS PhD Admission in the US}\label{part:intro}
...
International students, especially those from less well-known universities and smaller countries, often wonder if they should apply to a CS PhD program in the US. Common concerns include (i) the \textbf{difficulty of getting admitted}, (ii) the \textbf{cost of graduate study} in the US, and for some, the fear of \textbf{discrimination} based on gender identity, sexual orientation, or cultural background.
...
\paragraph{Discrimination is not tolerated} Third, higher education in the US take a very strong stance against discrimination, especially at the university level.
Many resources are available to encourage and support students from minority groups to pursue research, e.g., specific scholarships and fellowships. Faculty in CS are also \emph{very} familiar with and are highly encouraged to support such students in their group. There are also incentives, such as dedicated funding, to motivate faculty to recruit and mentor minority students (\autoref{sec:urm}).
...
While this guideline can be useful for all students, it would most benefit \textbf{international students} from \textbf{smaller countries and less well-known universities} (or domestic students from US universities with no PhD programs or limited research opportunities).
...
This document also aim to explain the \emph{``why''} behind the admission process, e.g., why LoRs are important, why you should not draft your own LoR, why you should contact professors, etc. There are numerous \href{https://github.com/nguyenthanhvuh/phd-cs-us}{resources online} from students  that tell you \emph{``what''} to do, but few explain the \emph{``why''}. Understanding the reason and mindset of the admission committee and profs. can help you prepare better.
...
\subsection{Why CS depts do not waive the application fee?}\label{sec:fee-waive}
...
\part{Your Application Materials}\label{part:application}
...
\chapterinfo{\emph{LORs are very important}, but only if they are personalized and talk about your research ability.}
...
The letter should 
focus on your research background, achievements, and potentials, all of which paint a compelling picture of you as a researcher.

\section{LoR writers}\label{sec:lor-writers} 
...
A LoR writer should be someone who \emph{knows you well}, so that they can provide a strong-supporting and personalized letter for you.  LoR writers should also \emph{have the credibility} to convince adcom members on your research ability and potential. Such a person is typically someone who has a PhD (so they know what a PhD is about) and is active in research (so they can evaluate your research ability). LoR writers are often your research advisers, professors, or supervisors who have worked with you on research projects.

\subsection{LoR from Famous People}  Having a strong letter from an internationally recognized researcher will \emph{greatly strengthen} your application. A strong LOR from such a researcher can outweigh the lack of publications (or low GPA or unknown school). The reason is simple: adcom members trust people that they know and respect. If a well-known researcher enthusiastically recommends you, then the adcom members will likely trust that recommendation.
...
Many students write letters themselves, typically due to the requests of their profs. or letter writers. Such letters have \emph{little value} and are considered weak by reviewers---why can you not even find someone who cares or knows enough about you to write a candid personal reference letter?  Instead of the ref. writer talking about you, in it is you who write about yourself (and they just sign the letter). 
 

Adcom members are just too experienced (having reviews hundreds of those letters) to spot and suspect such letters.  There is a very difference between a letter written by an experienced professor and a student.  For example, they can provide convincing and concrete examples based on their experience and compare you to their own students, and of course the writing style of a professor is very different from an undergraduate student.  Worse yet, if we suspect that the student wrote the letter, it is a \red{red flag} as we will question both the student's integrity and the letter writer's credibility.
...
As mentioned in~\autoref{sec:lor-writers}, LoR writers should be someone who knows you well and has the credibility to evaluate your research ability.  You can explicitly ask if they are willing to write a strong letter for you.  If they are not willing (you should be thankful that they are honest with you), then you should ask someone else.

% Below are some tips to approach your LoR writers:
% \begin{itemize}
% \item \textbf{Ask in advance}: You should ask for LoRs \emph{at least a month} before the deadline. People are busy with their own work and likely have many other students asking for LoRs. Also, a strong LoR takes time to write, so you should give them enough time to write a strong letter for you.

% \item \textbf{Help your writers}: You should provide your writers with details about the programs you are applying to, the deadlines, and any other information they need to know.  You should also provide them with details about your research experience and potential so that they can write a strong letter for you.
% \item \textbf{Follow up}: After you ask for LoRs, you should follow up with your writers to make sure they have submitted the letters on time.  You should also thank them for writing the letters for you.
% \item \textbf{Waive your right}: When you ask someone to write a letter for you, you will be asked if you want to waive your right to see the letter.  You should always waive your right.  This shows that you trust your writers and that you are not trying to twist their words.
% \item \textbf{Remind your writers}: After you enter your writers' information in the application system, you should tell your writers about that and let them know they will soon receive an email from the university to submit their letters.  You should also remind them when you submit your application and ask them to submit their letters on time if they haven't done so.
% \item \textbf{Help your writers}: To help your writers write a strong letter for you, you should provide them with details about your research experience and potential.  You should also provide them with a draft of your SOP so that they can see what you are saying about yourself and complement that with their own perspective.
% \item \textbf{Thank your writers}: After your writers have submitted their letters, you should thank them for writing the letters for you.  You should also let them know the outcome of your applications.
% \item \textbf{Ask for feedback}: After you have been admitted or rejected, you should ask your writers for feedback on your application.  This will help you improve your application for future applications.
% \item \textbf{Stay in touch}: After you have been admitted or rejected, you should stay in touch with your writers.  This will help you build a relationship with them and will help you in the future.
% \end{itemize}
...
Note that most places only have deadlines for the applicant, but are very flexible with the letter writers.  In many cases your LOR writers \emph{are not given any deadline}. The following lists several LOR invitation emails I received from various universities in the past few years: 
...
For a student that I know well, I will write them a strong letter, which takes a lot longer as it will be personalized.  While I have a general template for LoR, it still can take me an hour or more to write it.  I often ask the students to provide information (\autoref{sec:help-your-LOR-writers}) and what they think I should highlight in the letter. They can also provide me their SOP (if they already have written one) so I can complement what they say with my own perspective.  I often do not share what I write with the students, just to keep it more genuine and honest.  
...
\section{Publications} The most concrete evidence of research ability is having \emph{papers in reputable international journals or conferences}.
...
\chapterinfo{\emph{SOP is important}. Write it in such a way that makes you \emph{stand out}.}
...
\begin{commentbox}[Vu:]
One common pitfall is to write about how you are from a poor family, a small town, or a developing country.  These are not related to DEI and raise concerns about you not understanding or even bother to do some basic research about the topic.   I have seen people consider themselves as minority because they are Asian or international students studying in the US (have you seen how many Asian or international students are in CS programs in the US?).\\

Moreover, do not make up stories or exaggerate your experiences.  Just show your awareness and understanding of the topic and what you did or how you plan to contribute to it (e.g., mentoring students, helping others). One of the best DEI statements I have read starts the acknowledgement that the applicant is not a minority, but a white male in a STEM field (i.e., that make them the majority), and that they do not have much experience in DEI, but show that they are aware of the challenges faced by minority groups and how they can contribute to it.
\end{commentbox}
...
\chapterinfo{\emph{High grades probably won't help much} (unless you're from a very top and well-known school), but bad ones likely will raise concerns.}
...
Many international students mistakenly believe that their school is well-known, but in fact, it is not, e.g., many Vietnamese students believe that ``Bach Khoa'' is well-known, but it is not (and their confusing acronyms HUST and HCMUT only make it worse).  So if you think your school is well-known, mention it (and back up with some evidence like rankings or awards) in your SOP.  You can ask your LOR writers to talk about your school as well (\autoref{sec:help-your-LOR-writers}).
...
\chapterinfo{\emph{Standard tests are not important}. GRE typically \emph{is not} required. For standard English tests (not required for domestic students), just do enough to pass the minimum requirements.}

\section{GREs Are Optional and Do Not Matter} While a few schools still require taking the GRE (e.g., UCF), most good CS PhD programs in the US \textbf{no longer} require it. Thus, if you haven't taken the GRE or have bad scores, then don't waste time (re)taking it. Being optional really means optional, and not taking it will not hurt your application.
...
\begin{commentbox}[Vu:]
    Unlike a job application, CV is not as important for PhD admission because we do not screen applicants based on their CV.  Moreover, we care and pay attention more about your LOR, SOP, etc.  So do not spend too much time on your CV, just make sure it is easy to skim through and well-organized around research activities and achievements.
\end{commentbox}
...
\chapterinfo{Getting an interview is typically a \emph{good sign}; but no interview does not mean rejection}
...
\sectioninfo{Grad programs often wait for the accepted students to make their decisions, typically by April 15, before sending out rejection letters.}
...
\paragraph{School \autoref{chap:your-school}} Adcom already knows about your school, which is a plus (see \autoref{chap:your-school}). You are also more familiar with the US education system and culture (so hopefully you are aware of the cultural issues listed in \autoref{sec:cultural}).
...
% \paragraph{Evaluating the application's research potential, \emph{not} the project potential} This is very different than a normal proposal like an NSF one that asks for funding for a specific project. In such case the project is evaluated.  However, in the GRFP, the research potential of the applicant is evaluated, not the project.  This means that you should focus on your research experience, your potential to do research, and how you can contribute to the field, etc.  You should also focus on your broader impacts, e.g.,  how you can help improve STEM education through outreach and mentoring, how you can contribute to diversity and inclusion in STEM fields, how you can help society, etc.
