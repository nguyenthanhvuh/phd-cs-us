...
You should just do well enough to pass the minimum requirement set by the university. %, which is required for TA (\autoref{chap:funding}).
...
There are other things you might not think are important but can make you stand out. For example, if you have a strong background in a non-CS field but can be integrated with CS, e.g., you have a degree or background in \emph{dance} or \emph{music} and want to integrate them with CS, do talk about it. Are you a female or a minority in CS? Do you participate in outreach activities that help increase diversity and inclusion in CS? Diversity is valued in CS programs in the US (\autoref{sec:urm}), and experiences in these areas can make you stand out and get noticed from reviewers.
...
For external fellowships including those from the US government (e.g., NSF GRFP, DOD NDSEG) and tech companies (e.g., Google, Microsoft, Facebook), you will need to apply.  % However, tech companies including Google, Microsoft, Facebook have fellowships that international students can apply for.
...
\chapter{Choosing Schools}\label{chap:schoolsandprofs}
...
Because of the differences between MS and PhD programs (\autoref{sec:phd-vs-ms}), you should consider different factors when selecting and ranking MS programs. For example, you might want to consider factors such as location, industry connections, and job placement instead of research areas and advisers (\autoref{chap:schoolsandprofs}).
...
Having an external and major fellowship can significantly improve your chances of getting into a good PhD program (\autoref{sec:fellowships}).  The National Science Foundation Graduate Research Fellowship Program (NSF GRFP) and the Department of Defense National Defense Science and Engineering Graduate Fellowship (DoD NDSEG) are two of the most prestigious fellowships for CS PhD students who are US citizens or permanent residents.  It is rumored that several universities would revert their admission decision on a student if they get one of these fellowships.


The \href{https://www.nsfgrfp.org/}{GRFP} and \href{https://www.ndsegfellowships.org/}{NDSEG} website have detailed information on the application process and eligibility requirements. This section focuses on how your application is evaluated and tips on improving your application. Note that while these are specific GRFP and NDSEG, the general advice can be applied to other major fellowships (those for non-US citizens or permanent residents). 




%Securing a prestigious fellowship such as the National Science Foundation Graduate Research Fellowship Program (NSF GRFP) or the Department of Defense National Defense Science and Engineering Graduate Fellowship (DoD NDSEG) can significantly enhance a student’s prospects for admission to a strong PhD program. These fellowships not only provide financial support but also offer academic freedom and prestige that can set an applicant apart from their peers. However, successfully obtaining one of these fellowships is no easy feat—they are highly competitive, and applications are scrutinized rigorously by expert reviewers.

%One of the biggest advantages that applicants from elite institutions often have is access to faculty members who are well-versed in the review process. These faculty members understand the nuances of writing strong letters of recommendation (LoRs) and guiding students through the proposal-writing process. Unfortunately, students from smaller institutions or those with mentors unfamiliar with NSF or DoD fellowship reviews may find themselves at a disadvantage—not because of their potential or research ability, but simply due to a lack of insider knowledge about what makes a strong application.

%This chapter aims to level the playing field by providing an insider’s perspective on how these applications are reviewed. Drawing from my experience as a reviewer for both NSF GRFP and DoD NDSEG, I will demystify the evaluation process, highlight key elements that make applications stand out, and offer strategic advice for applicants and their letter writers. While research experience and proposal quality are, of course, crucial to success, understanding the review criteria and expectations can be just as important.

%Moreover, this chapter will provide guidance for LoR writers, helping them craft letters that effectively support their students’ applications. Many well-intentioned letters fail to address the aspects that reviewers prioritize, which can unintentionally weaken an otherwise strong application. By offering insights into what reviewers look for, I hope to empower both applicants and their mentors to present their strongest possible case for these fellowships.

%Whether you are an aspiring PhD student preparing your application or a faculty member writing a recommendation, this chapter will equip you with the knowledge needed to navigate the NSF GRFP and DoD NDSEG review process with confidence.
...
The NSF GRFP is a prestigious fellowship for US citizens, nationals, and permanent residents who are in the early stages of their graduate study in STEM fields, including both MS and PhD students. The fellowship provides three years of financial support, which includes a stipend and tuition. The GRFP is highly competitive, with many applicants from top schools, with strong LoRs and research experience.
...
\item \textbf{Too Technical.} Remember that you're writing to a general audience in CS, not experts in your field.  While NSF tries to match reviewers with your field, CS fields are simply too broad and you might get a reviewer in the field but not in your specific area or familiar with the problem you're working on. 
So avoid technical jargon and explain things in simple terms. If the reviewer cannot understand your proposal, they will likely give you a low score.
...
\item \textbf{Overexaggeration Lors.} Many GRFP applicants are from top schools with well-known professors that are very good at writing. However, they often use flowery language and completely overrate their students. Reviewers are  professors themselves and can sense this overexaggeration.  So you should ask your LoR writers to tone down the language (similar to overclaiming research conributions when writing papers) and and be specific with concrete examples to demonstrate why you're \emph{``the best''}.
...
The NDSEG is another prestigious fellowship supporting \emph{U.S. citizens} pursuing advanced degrees in STEM fields \emph{critical to national defense} (such as CS).
It provides up to three years of funding, including a  stipend and tuition coverage.
...
Finally, just as with the NSF GRFP and even PhD SOPs, ask your LoR writers and adviser to look at your writing/essays. You are new to the field and research writing, and your ideas might not be accurate or have already been explored. It's better that they tell you now than for you to find out later from reviewers.
