...
Ultimately, choose a prof. that fits you the most by communicating with them, taking their courses, meeting them, asking them questions, and even talking to their current students. Doing these takes a lot of time and effort, but remember, you will be working with this person for 5+ years, so it is important to try to find the right one. 
