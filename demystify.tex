...
\paragraph{Overexaggeration Lors} Many students have LoRs that overrate them, e.g., \emph{``the best student I have ever had''}, \emph{``better than most PhD students''}, etc.  This is not only not convincing but can also hurt your application.  Reviewers are often professors themselves and know that such statements are often not true.  Moreover, such statements can bias the evaluation, e.g., if a reviewer sees that a student is from a top school and has a LoR from a top professor, they might give the student a higher score than they deserve.  So you should ask your LoR writers to be honest and specific, e.g., \emph{``the student did well in my class and I think they have the potential to be a good researcher''}.
