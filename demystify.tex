  ...
  \item Choosing School and Professors
    ...
    \item Miscs and FAQS
        \begin{itemize}
          ...
          \item Don't buy computer equipment and electronics for research, ask your prof. if they can buy them for you (\autoref{sec:buying-equipment}).
...
\paragraph{Not getting interviews} While it is generally good to get interview, not getting an interview does not mean you're out.  Many programs do not have the tradition of interviewing applicants. For example, at GMU, most of our admitted students with TA do not go through interviews. 
...
\textbf{How to get RA?} When a professor recruits you, they might offer you an RA right away (e.g., when you apply).  A common scenario is that you first get admitted with TA, and then after a year or two find an adviser to support you with RA. RA is never guaranteed as it depends on the funding situation of the prof. So you should also pay attention to TA, e.g., see if TA is readily available for PhD students in the program.
...
You likely need to apply for external fellowships including those from the US government and tech companies (e.g., Google, Microsoft, Facebook).  Fellowships from US government would likely require US citizenship or residency. % However, tech companies including Google, Microsoft, Facebook have fellowships that international students can apply for.
...
For example, in the 2024 admission cycle, there is a huge surge in students interested in AI and NLP (thanks, ChatGPT!). Thus, AI/NLP faculty might be overwhelm with potential students and cannot take additional students, many of whom have excellent profiles.
...
\section{I am a member of an underrepresented group in CS}\label{sec:urm}
One question that often comes up is if you should mention, e.g., in SOP, that you are a member of an underrepresented and minority (URM) group. This question arises often for international (and even domestic) students. The main worry is that they might get discriminated against, as often happen in their countries or personal experiences. %, and (ii) mentioning this might make them look like they are asking for special treatment.

In my personal opinion, the short answer is \emph{yes}, it \emph{does} help, especially if you can articulate your experiences and how you can contribute to diversity and inclusion in CS. Most universities have a strong commitment to diversity and inclusion and want to  
\emph{increase the number of URM students} in their programs (e.g., GMU is consistently ranked as one of the most diverse universities in the US). Moreover, many universities and industrial organizations also have specific scholarships and fellowships for URM students (so you should look for specific scholarships for URM students).

It is understandable that some students might feel uncomfortable mentioning this in fear that they lost a chance of working with a prof who might be biased against URM students.  However, if a prof. has such an issue, then you might not want to work with them anyway (and it is likely that the university would not tolerate such behavior). In my experience, it is the opposite: many profs. are actively looking for URM students to work with, and mentioning this in your application can help you stand out. 

In addition to being aware of the importance of diversity and inclusion in CS and want to contribute to it, profs. have incentives to work with URM students. For example, professors often seek grants from government sponsors such as NSF, which strongly encourage broadening participation in STEM (e.g., see \href{https://new.nsf.gov/cise/broadening-participation}{here} and \href{https://www.nsf.gov/pubs/2022/nsf22125/nsf22125.jsp}{here}). If in doubt, seek advice from your close professors and collaborators about this.
...
\section{Buying Computer Equipment}\label{sec:buying-equipment} Many students, including myself, get very excited about getting to buy new computer equipment and electronics when they start their PhD. However, you should check with your adviser first.  Many profs. have funding to buy you a computer and other equipments (e.g., keyboards, headphones, tablets, books, etc). 

\section{Can I negotiate my PhD offer?}\label{sec:negotiate}
For stipend, unlikely, as TA is set by the university and while RA is set by the adviser, it is often based on the department's standard and it would be unfair to other students if you get more. However, your stipend is often increased every year (by a small amount and automatically) and will be more after you pass your qualifying exam.

For start date or TA assignment (e.g., TA a specific course), it is uncommon but you can ask for it. Also, there is typically no moving allowance for PhD students. In short, things that are standard and set by the university or department are unlikely to be negotiable.  However, you can ask for things such as computer equipments (\autoref{sec:buying-equipment}), books, (and sometimes even furniture) and conference travel budget.
...
\paragraph{Standard Tests \autoref{sec:grades}} You do not need to take TOEFL or IELTS because you already did your undergrad (or MS) at a US university.  You might also be more comfortable communicating in English, e.g., contacting professors (\autoref{sec:contact}).
...
Students, especially international ones, often get confused on what to do after they get an offer from a professor, e.g., is it OK to postpone or accept/reject offers, and most importantly, how to do so without offending anyone. Many wonder about accepting an offer and then later rejecting it.  This section provides some guidance on these issues.

In short, if you are not serious about an offer for any reason (e.g., still waiting for other offers), do not accept it.
