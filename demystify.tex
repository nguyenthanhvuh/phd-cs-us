...
Originally, this document was intended for international students, but I have expanded it to include information that might be useful for \emph{domestic students} as well.
...
Students, especially those from smaller countries or less well-known universities, often wonder if they should apply to a CS PhD program in the US. Specifically, they are worried about the \emph{difficulty} of getting admitted and the \emph{cost} of studying in the US. This section addresses these concerns.
...
\autoref{sec:summary} provides an overview of the application process, which you can explore in further details in the following chapters.
