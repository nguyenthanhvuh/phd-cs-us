...
\emph{increase the number of URM students} in their programs (e.g., GMU often advertises about being one of the most diverse universities in the US). Moreover, many universities and industrial organizations also have specific scholarships and fellowships for URM students (so you should look for specific scholarships for URM students).
...
In addition to being aware of the importance of diversity and inclusion and want to contribute to it, profs. have incentives to work with URM students. For example, professors often seek grants from government sponsors such as NSF, which strongly encourage broadening participation in STEM (e.g., see \href{https://new.nsf.gov/cise/broadening-participation}{here} and \href{https://www.nsf.gov/pubs/2022/nsf22125/nsf22125.jsp}{here}). Prof. can also apply for grants from organizations and private donors, which have specific programs for URM students.  Thus, having URM students in their group can help them get these grants.

In the end, this is your choice and you do what make you feel comfortable. However, just be aware that URM is often a (huge) plus, not a minus, in CS in the US. If in doubt, seek advice from your close professors and collaborators about this.
...
For stipend, unlikely, as TA is set by the university and while RA is set by the adviser, it is often based on the department's standard, and it also would be unfair to other students if you get more. However, your stipend is often increased every year (by a small amount and automatically) and will likely increase after you pass your qualifying exam.
...
Most of what is written in this document is applicable to both domestic\footnote{Domestic simply means you did your undergrad (or MS) at a US university.} and international students.  However, there are some differences and benefits that domestic students should be aware of.  This section lists some of these.
