...
\begin{itemize}
    \item \textbf{Send emails to the wrong prof.}. While this is not mentioned, it is the number one reason why you don't get a reply: you send email to profs. who do not / cannot advise CS PhD students (e.g., adjunct, emeritus, teaching, non-CS, etc.). See \autoref{sec:faculty-types} for details.
    ...
    \item \textbf{Too long}. Keep it to about 3--4 paragraphs. Seriously, less is more and too long emails are often not read and discarded.\\
    ...
    \item \textbf{Ignoring the Prof's guideline} and asking questions that are already answered on their website (most CS profs have personal websites). For example, on my website, I put very specific information on how to contact me (e.g., email subject).  Following this helps you stand out, and I will likely respond to you than others.
    \item \textbf{Fancy format}. CS (and probably many other fields) likes plain email.  Do not use colors, fonts, or fancy formats.
