...
\begin{domesticbox}[Domestic students:] If you're a domestic student, you have several advantages in your application.  First, we already know about your school (see \autoref{sec:your-school}), and you are also more familiar with the US education system and culture.  You also have more opportunities for funding, e.g., through government scholarships for US citizens and residents. Finally, compared to international students, PhD applications in CS from domestic students are few and that can really help your case.
\end{domesticbox}
...
The most concrete evidence of research ability is having \textbf{published papers in reputable international journals or conferences}.
Having published papers, especially at top venues, is a sign that the applicant has successfully involved in research.
...
After you submitted your applications, the waiting game begins! For many students, this is an excruciating time. This section provides some information and tips to help you get through this time.

% but you should try to relax and focus on your study and work.  You can also use this time to improve your profile, e.g., by working on research projects, publishing papers, or improving your connections for better LoR writers.

\paragraph{Interviews} Just like a job application, you can get interviews from some schools. The most common case is that a professor is interested in working with you and want to chat to make decision (e.g., to offer RA).
The professor might include one of their current students as part of the interview.

In some case, the interview is done by several professors, e.g., to see if a student fits to their group or to recruit a very strong student to their program. The interview can also be done by adcom members to see if the student fit their program.
...
\paragraph{Not getting interviews} While it is generally good to get interview, do not feel so despair if you do not get any.  Many programs do not have the tradition of interviewing applicants. For example, at GMU, most of our admitted students with TA do not go through any interviews.


\paragraph{Timeline} The timeline for interviews and notification letters varies.  Faculty setup interviews based on their (very busy) schedule. So do not be surprised if you get an interview invitation in the last minute (also don't get surprised if your interview is on a Uber ride!). And again, some schools do not do interviews at all.

Some schools send out admission letters in batches, some do rolling admission, and some do not send anything out (e.g., you're on their wait list).  However, in general, you should hear back from most schools by around March.

In short, you should not worry too much about the timeline. Also do not send emails asking about interviews or status.


\paragraph{Updating your profile} In general, you should not send emails to update your profile.  However, if you have new publications or other achievements, you can send an email asking to update your profile.
...
\textbf{How to get RA?} When a professor recruits you, they will likely give you RA right away (e.g., when you apply).  A common scenario is that you first get admitted with TA, and then after a year or two find an adviser to support you with RA. See how to contact a prof. in \autoref{sec:contact} for research opportunities.
...
External fellowships including from the US government and tech companies (e.g., Google, Microsoft, Facebook).  Fellowships from US government would likely require US citizenship or residency. % However, tech companies including Google, Microsoft, Facebook have fellowships that international students can apply for.
...
In general, fellowship, especially competitive ones from the government or company, is prestigious, and you will stand out if you get one.  Every PhD student has pubs, but only superstars have NSF grad or Microsoft fellowship. In fact, these are so prestigious that even if you didn't get it but make it to the final round or even ``honorable mentioning'', school will still mention you on their website and you still should put it on your CV.
...
It is worth noting that professors in a non-CS department also unlikely can serve as formal PhD advisers for CS students (see \autoref{sec:related-fields}).

\paragraph{Titles} Faculty have rankings, e.g., assistant, associate, full, regardless if they are tenure line or teaching.  Assistant means new faculty, associate means they have been promoted, and full means they are senior. A tenure track faculty starts with being an assistant professor and then gets tenure and promoted to associate (typically after 6 years) and then full (time varies, some become full within 3-4 years, some 10+ years, some remain associate).
...
Many possible reasons!  Other than the obvious ones (e.g., weak research pontentials, low GPA, weak LoRs, unclear SOP), here are some that you might not expect:
\begin{itemize}
  \item  \emph{Your English scores (e.g., IELTS or TOEFL) are not high enough}.  While professors do not care much about these, there is a certain minimum set by the college or the university that you need to pass to get admitted, especially if you want to get funding (e.g., you need to be able to communicate well with students as a TA).  Note this is mostly for international students, as domestic one do not have to take these tests.

  \item \emph{No faculty available to advise you}.  You could have an excellent profile, but if there is no faculty who can advise you (e.g., they already have too many students), you will not be admitted. This is actually for your own good because you do not want to be in a program where you cannot find an adviser.
\end{itemize}

\section{Should I ask for feedback?}
No, don't bother.  You will likely not get any useful feedback.  We cannot reveal your evaluation results (e.g., if we say because you have weak LORs, then that would reveal something about your writers) or give you advice on how to improve. So it is best to just move on.  If you really want feedback, ask your professors, collaborators, ref writers, or those who have previously applied.
