...
Adjunct faculty is not full-time, e.g., they might be working in industry and teach a class or two for fun.  Emeritus means they are retired but still have some affiliation with the university.   Due to their roles, adjunct, emeritus, and research faculty typically do not advise PhD students.

Some universities have \emph{research faculty} or research scientists, who are typically non-tenure line faculty and focus on research (e.g., publishing papers and getting grants). While they cannot solely graduate PhD students, they often co-advise and mentor students with tenure-line faculty. They can recruit students and provide RA funding for them.  They can also teach classes, but typically have a lower teaching load than teaching faculty.
