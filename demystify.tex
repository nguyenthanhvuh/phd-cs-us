...
\begin{itemize}
\item \href{http://www.pl-enthusiast.net/2022/10/03/how-to-write-a-grad-school-personal-statement/}{How to Write a Grad School Personal Statement} by Mike Hicks, 10/03/22
\end{itemize}
...
\subsection{Tenured, Tenure Track, Teaching,  Assistant Profs., Associate Profs, and Other Academic Titles}\label{sec:faculty-types}
...
\begin{itemize}
    \item \href{https://yonatanbisk.com/emailing_professors.html}{Emailing Professors} by Yonatan Bisk
\end{itemize}
