...
Many PhD programs have the tradition of interviewing applicants. The most common case is that a professor is interested in working with a student and so want to chat with them to make decision (e.g., to offer them RA).
