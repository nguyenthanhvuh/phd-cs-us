...
Much of these uncertainties stem from the lack of information and guidance on the admission process in the US (social places like Facebook and Reddit are full of confusion and contradictory information).  This book aims to address these concerns.
...
This book also aim to explain the \emph{``why''} behind the admission process, e.g., why LoRs are important, why you should not draft your own LoR, why you should contact professors, etc. There are numerous \href{https://github.com/nguyenthanhvuh/phd-cs-us}{resources online} from students  that tell you \emph{``what''} to do, but few explain the \emph{``why''}. Understanding the reason and mindset of the admission committee and profs. can help you prepare better.
...
\section{Competitions} Winning \emph{internationally recognized competitions} can demonstrate your research potential.
...
\section{How Applications are Evaluated}

\begin{itemize}
\item Each applicant is assigned to ~3 reviewers who have expertise in the applicant's research topics (so only your field but also your specific area).  This means reviewers can be quite knowledgeable in your field and your work, your LoR writers and their work, and thus can evaluate your application quite well.
