...
\subsection{Funding}
Unlike PhD programs, which typically guarantee funding (\autoref{sec:funding}), MS programs are typically not funded. You have to pay tuition, which can be expensive. It is difficult for an MS student to get funding, e.g., through TA or RA positions, because these are typically reserved for PhD students.
\begin{itemize}
