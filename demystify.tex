...
If you're reaching out to a professor for the first time,  address them as either Prof. Lastname or Dr. Lastname. I've noticed that many international students tend to use the titles Prof. or Dr. FirstName LastName, but this can come across as if you're simply copying and pasting names. It's not necessary, so stick with Prof. or Dr. Lastname.

Furthermore, it's important to avoid using Mr. or Mrs., or the professor's first name if you're not acquainted with them yet. This approach may be seen as somewhat disrespectful, especially in academic fields where most professors hold advanced degrees. As you become more familiar with a professor and depending on their preferences, you may transition to addressing them by their first name. For instance, my students and colleagues call me Vu. Some students also refer to me as Dr. Vu, which I find somewhat amusing but am perfectly fine with.

Note that in some universities, e.g., those that do not offer PhD degrees, the formal title Dr. Lastname is commonly used. It's essential to observe and follow the conventions at your particular institution. Additionally, be aware that not all faculty members may hold a Ph.D., in which case using Prof. Lastname is a suitable alternative.
