...
Many PhD programs have the tradition of interviewing applicants. The most common case is that a professor is interested in working with a student and wants to chat with them to make decision (e.g., to offer them RA).
The professor might include one of their current students as part of the interview.
In some case, the interview is done by several professors, e.g., to see if a student would fit in their group or to recruit a very strong student to their program.
