...
The focus of adcom is to evaluate your background and interest in research to see if you \textbf{fit} into our program and can handle a PhD in CS, which is a \emph{research} degree!  To evaluate your profile, we consider the following key indicators.
...
The first 2 years you typically take coursework (somewhat equivalent to an MS study), find an adviser, and learn how to do research.  The next 2--3 years you focus on your research, form a dissertation topic, and get results published. The last 1-2 years you continue to publish, write and defend your dissertation, and look for a job.
