...
\chapterinfo{\emph{Yes, definitely}.  CS PhD study in the US is fully funded and admission into good universities is not any harder than in other countries.}
...
\sectioninfo{\emph{High grades probably won't help much} (unless you're from a well-known school), but bad ones likely will raise concerns.}
...
\chapterinfo{Celebrating! Now it is your turn to evaluate the school!
...
\subsection{How much do \emph{I} cost?}\label{sec:ra-cost}
...
\sectioninfo{One reason why you were rejected is because you applied to AI/ML, a super competitive field in recent years with many applicants.}
...
\sectioninfo{It takes about 10 minutes to review an application.}
...
\sectioninfo{Being a minority can significantly help your application.}
...
\begin{description}
  ...
  \item[RA] Research Assistantship. A form of funding where you work as a research assistant for a professor.
  \item[TA] Teaching Assistantship. A form of funding where you work as a teaching assistant for a professor.
  \item[TOEFL] Test of English as a Foreign Language. A standardized test to measure the English language ability of non-native speakers.
  \item[IELTS] International English Language Testing System. A standardized test to measure the English language ability of non-native speakers.
  ...
  \item[NSF] National Science Foundation. A US government agency that supports research and education in science and engineering. NSF is a major source of funding for RAs in CS research. There are other agencies that support RAs but they might require US citizenship or permanent residency.
        \item [R1 vs. R2 Universities] Research 1 (R1) universities are universities with the highest level of research activity. Research 2 (R2) universities have a high level of research activity but not as high as R1 universities.  R1 universities are typically more prestigious and have more funding and resources for research.  R2 universities are also good but might have fewer resources and funding.
