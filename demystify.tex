...
Your \emph{school} might not be as good as you think.  It might be T1 in your country (or in your own definition), but US faculty does not know about it, e.g., most US faculty would not know about schools in Vietnam.  

Your \emph{research} might not be as strong as you think.  Doing research does not mean much (or anything) if there is no results, e.g,. publications. Publications might not have much value if they were published localled or through unknown places.  Even papers at top venues might not be as good as you think, e.g., many AI/ML/NLP faculty are not too interested in ``dataset'' papers at NeurIPS.
