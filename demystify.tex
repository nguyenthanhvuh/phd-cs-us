...
\paragraph{Overexaggeration Lors} Many GRFP applicants are from top schools with well-known professors that are very good at writing. The issue is that they often use flowery language and overrate their students. Reviewers are often professors themselves and can detect B.S. So you should ask your LoR writers to be honest, tone down the language (similar to overclaiming research results when writing papers), and be specific with concrete examples to demonstrate why you're ``the best''.
