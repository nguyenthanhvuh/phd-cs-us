...
The GRFP website has detailed information on the application process and eligibility requirements. This document focuses on how your application is evaluated and how you can improve your chances of success.
...
\subsection{Common Pitfalls}\label{sec:grfp-pitfalls}
...
\paragraph{Related Work} Many research plans motivate the problem well but do not discuss limitations of existing work, making it questionable if the problem is important or if you are aware of the challenges.  Thus, you should do a thorough literature review and discuss what people have done and their limitations.  Your research plan should then talk about how you plan to address these limitations, i.e., fill the gap in the literature.  


\paragraph{Do NOT BS} Many research plans include technical details or proposed work that are vauge, unrealistic, or even impossible.  This is similar to a student taking an exam and write a lot of nonsense to fill the page and hope for partial credits.  As mentioned, reviewers are often chosen based on their expertise in your field and can detect B.S. Again, do your homework and ask someone who knows the field, e.g., your advisor or LoR writer, to review your research plan.


\paragraph{Overexaggeration Lors} Many GRFP applicants are from top schools with well-known professors that are very good at writing. The issue is that they often use flowery language and completely overrate their students. Reviewers are often professors themselves and can sense this overexaggeration.  Moreover, they often know the LoR writers and can compare the LoR with the student's application and see if they match.   So you should ask your LoR writers to be honest, tone down the language (similar to overclaiming research conributions when writing papers), and be specific with concrete examples to demonstrate why you're \emph{``the best''}.
...
These are some common pitfalls I see in NDSEG applications and some tips to avoid them.  While some of these are similar to NSF GRFP (\autoref{sec:grfp-pitfalls}), some are specific to NDSEG.
