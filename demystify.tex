...
Many students lament that they get no interviews or are rejected (with strong profiles) and that the process seems random.  However, while it is true that the process is not perfect, it is not random.
There are many possible reasons!  Other than not having a strong profile (e.g., research potential, GPA, LoRs, SOP, poor interviews), here are some other reasons.
