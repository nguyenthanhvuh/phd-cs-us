...
Yes, as long as you can demonstrate you are ready for CS PhD research through research experiences, LoRs, statements, etc as mentioned. You might be even able leverage this to make your profile stand out.
...
\subsection{How do I address a professor Firstname Lastname?}
...
\section{Rankings of CS PhD programs in the U.S}\label{sec:ranking}
  ...
  \begin{table}[h!]
    \centering
    \small
    \caption{Top 50 CS PhD programs in the U.S. (CSRankings, June 2023). \red{$^*$} indicates the university has a \href{https://github.com/dynaroars/dynaroars.github.io/wiki/Viet-CS-Profs-US}{Vietnamese prof.} that can advise CS Ph.D. students.}\label{tab:ranking}
  \begin{tabular}{rl|rl}
    \toprule
