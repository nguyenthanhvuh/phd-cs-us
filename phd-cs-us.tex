...
For Vietnamese students, it's worth highlighting the \href{https://vef2.org/}{VEF 2.0 program}, which has played a crucial role in aiding many good students in gaining acceptance to top-tier PhD programs in the US. VEF 2.0 follows an intriguing model where  US faculty members from leading institutions are invited to conduct rigorous interviews with VEF students and subsequently provide reference letters on their behalf. Despite the limited interaction between the interviewer and the interviewee (primarily confined to the interview itself), the impact of these reference letters is remarkably positive. This fact is underscored by the noteworthy success of numerous VEF 2.0 students in securing admission to top CS PhD programs across the US.
...
\vspace{-0.2in}
      \begin{center}
        \includegraphics[width=1\linewidth]{c8.png}
      \end{center}
      \vspace{-0.2in}
    \end{wrapfigure}
...
\vspace{-0.2in}
\begin{center}
\includegraphics[width=1\linewidth]{c4a.png}
\end{center}
\vspace{-0.3in}
\end{wrapfigure}
...
\vspace{-0.3in}
      \begin{center}
        \includegraphics[width=1\linewidth]{c5.png}
      \end{center}
      \vspace{-0.5in}
    \end{wrapfigure}
