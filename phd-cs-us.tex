...
I started writing this document in May 2023 and have been updating it since then (mostly around deadline time when I tend to procastinate :p). I have shared it with many students and faculty members and received many valuable feedback.  I also hope that it will be updated and improved by many people in the future.  I have put the source code of this document on \href{https://github.com/nguyenthanhvuh/phd-cs-us}{GitHub} so that anyone can contribute to it.  I also hope that this document will be translated to Vietnamese and other languages so that it can reach more students.  
