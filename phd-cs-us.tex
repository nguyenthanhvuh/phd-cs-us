...
If you want to contact a prof. to \emph{ask about your admission chance}, then \textbf{don't}. We don't know, we can't answer because as explained throughout this document, we don't make individual decisions and might not even be assigned to evaluate your application.  It is the same as sending a paper draft to a journal editor and ask them if your paper will be accepted.
