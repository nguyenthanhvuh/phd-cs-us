...
\section{Rankings of CS PhD programs in the U.S}\label{sec:ranking}
  ...
  \begin{table}[h!]
    \centering
    \small
    \caption{Top 50 CS PhD programs in the U.S. (CSRankings, June 2023).  $^*$ indicates the university has a \href{https://github.com/dynaroars/dynaroars.github.io/wiki/Viet-CS-Profs-US}{Vietnamese prof.} that can advise CS Ph.D. students.}\label{tab:ranking}
  \begin{tabular}{rl|rl}
    \toprule
