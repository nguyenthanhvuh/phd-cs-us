...
\begin{itemize}[leftmargin=*]
\item  International students not familiar with US universities often put them into \emph{two} bins:  (i) very top school that they dream about such as Stanford, MIT, Princeton, Harvard and (ii) everything else.  Sometimes they rank CS programs using the reputations non-CS programs, e.g., medical or physics.
...
\end{itemize}
    ...
    \item Can I apply to PhD in CS if my undergrad was not in CS or any related areas?
    \begin{itemize}[leftmargin=*]
