...
This is one of the most common questions that international students often have. Faculty often received many mails from international students about admission, TA, RA and various related topics. Most of the time, we ignore these emails; but sometimes, we do answer them.  So under what cases we would answer and would not? 
...
If you want to contact a prof. to ask about \emph{research opportunities}, then \emph{may be}.  First, you should read the prof's website, see if they are saying something about contacting them. Many profs. indicate what you should do to contact them (e.g., specific email subjects). In general cases, you need to \emph{customize your email}. For example, read their papers, and see if you are interested in their work.  If you are, then you can send them an email talking how/why their work would match yours (give details and evidence, don't just say I am a software developer and therefore match with your interests in software design) and ask about research opportunities.  
