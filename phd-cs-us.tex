...
\begin{wrapfigure}{r}{0.30\textwidth}
    \vspace{-0.2in}
      \begin{center}
        \includegraphics[width=0.30\textwidth]{c4a.png}
      \end{center}
    \vspace{-0.2in}
    \end{wrapfigure}
    Typically, 5-7 years for Ph.D. in CS at a US university.  The first 1.5--2 years you spend on coursework and research.  The next 2--3 years you focus on your research, forming dissertation topic, and getting results published.  The last 1-2 years you write and defend your dissertation and look for job. The figure on the right is from PhDComics and shows the "ambition" level of a PhD student over their study.
