...
While this document is intended for Vietnamese students interested in Computer Science, it may be applicable to students in from various countries and disciplines.
Moreover, although many examples are for George Mason University, the writing should be generalizable to other R1\footnote{An \href{https://en.wikipedia.org/wiki/List_of_research_universities_in_the_United_States}{R1 institution} in the US is a research-intensive university with a high level of research activity across various disciplines.} universities  (though \emph{very} top schools could be very selective, e.g., see the \href{https://da-data.blogspot.com/2015/03/reflecting-on-cs-graduate-admissions.html}{admission process} at CMU).

In addition, this document can help \emph{US faculty and admission committee} understand more about international students and their cultural differences.  By understanding, appreciating, and even leveraging these differences, CS programs in the US can attract larger and more competitive application pools from international students.
...
This is a common question that international students have. Faculty often received many mails from international students about admission, TA, RA and various related topics. Most of the time, we ignore these emails; but sometimes, we do answer them.  So when we usually respond and when we do not? 

If you want to contact a prof. to \emph{ask about your admission chance}, \textbf{don't}. We don't know and can't answer because as explained throughout this document, we don't make individual decisions and might not even be assigned to evaluate your application.  It is the same as sending a paper draft to a journal editor and ask them if your paper has a chance.  

So what to do if you want someone to look at your profile and give input? You could ask your professors, people at your school, or contact those who have previously applied and get feedback. For these kind of feedback,  don't ask strangers like random profs., instead ask someone you have some personal connection to.  

If you want to contact a prof. to ask about \emph{research opportunities}, or \emph{GTA/GRA} support, then \emph{may be}.  The best way to catch the prof.'s attention you is to \emph{customize your email} to that specific faculty.  For example, read their papers, and see if you are interested in their work.  If you are, then you can send them an email talking how/why their work would match yours (give details and evidence, don't just say I am a software developer and therefore match with your interests in software design) and ask about research opportunities. Also, don't feel bad if they do not reply.

You should also read the prof's website, see if they are saying something about contacting them. Many profs. indicate what you should do to contact them (e.g., specific email subjects). 
