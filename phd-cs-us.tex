...
While I wrote this document for Vietnamese students interested in CS, it should be applicable to students in other countries.
Moreover, while many examples given are for George Mason University, the writing should be generalize to most other R1\footnote{An \href{https://en.wikipedia.org/wiki/List_of_research_universities_in_the_United_States}{R1 institution} in the US is a research-intensive university with a high level of research activity across various disciplines.} universities  (though \emph{very} top schools could be very selective, e.g., see the \href{https://da-data.blogspot.com/2015/03/reflecting-on-cs-graduate-admissions.html}{admission process} at CMU).
...
\section{How much do \emph{you} cost?}
PhD students often wonder how their salary is so low compared to their advisor's ludicrous grants or that why their offer letters sometime mentioned their benefits worth way more than what they actually receive (i.e., stipend).  This section aims to shed some light to these questions by breaking down how much a GRA costs to their advisor. 

Tab.~\ref{tab:cost} shows the budget breakdown for a GRA per year.
...
\begin{table}
    ...
    MTDC is Modified Total Direct Cost.}\label{tab:cost}
    \begin{tabular}{rcl}
