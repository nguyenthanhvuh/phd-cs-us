...
A strategy that I found effective is giving the entire class a small bonus point if everyone completes the evaluation. The bonus is computed as the percentage of responses * the bonus (X). So if X is 0.5 and everyone responds, everyone gets 0.5 points. If 50\% respond, each gets 0.25 points. While X is a tiny number, I emphasize that it can make a difference for borderline grades.  I don’t curve grades, so this is the only way for students to bump. I also emphasize that in my previous classes many students benefit from this.  So that really triggers their interest.  And also because evaluations are before final exams, everyone is incentivized to participate because they don’t know their final grades and don’t want to miss this opportunity.  Not only the students do it, they also remind their classmates/friends to do it.

I only employ this method recently, and response rate has been very good so far.  For Spr’24, it was 90\% (25/28 students) and for F’23, it was 100\% (16/16 students).  Before this, my response rate is about 50\%.
...
I did not do these visits, partly because I am not a travel person, and also I felt that I would not have problems finding letter writers.
Instead, during the Spring'23 semester before my tenure application, I put lots of effort in helping the university in recruiting faculty (by meeting with 20+ faculty candidates), even though I am not in the search committee and really didn't have service requirements during this pre-tenure study break. This helps me build a good relationship with my colleagues in the dept.



\section{3rd year Renewal Package}
...
Toward the end of your 3rd year (or early 4th year), you will need to submit a ``midterm'' \emph{renewal} application to renew your contract for the 4th year (and perhaps also 5th year).
While somewhat similar to tenure evaluation, this is less intense and  does not require reference letters or presentation.
%The department will then review your application and vote on whether to renew you for your 4th (and perhaps also 5th year). 
Your mentor presents and argues for your case in the dept. meeting, but the decision is made within the dept. and usually does not go up to the college or university.  It is still signed by the Dean, who often just follows the dept's recommendation.

While the renewal is straightforward for most people, it can be surprise and shock to some.
