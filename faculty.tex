...
\subsection{Serving on Program Committees (PC)} This is a good way to get to know what is hot in your field, and to get to know people in your field.  It is also a good way to get your name out.
...
\subsection{Volunteer for more Leadership roles} Once you have served on a few PCs and NSF panels, you should aim for more leadership roles.  For example, you can volunteer to be a chair of certain sessions/tracks of a large conference, or even a general chair of a workshop or conference.  These roles are more time consuming, but they are also more rewarding (e.g., more people will know about you) and in general will help your career, especially your tenure case.


\section{Service to the Department}
Your department chair will assign you to some committees to help run the department.  Typically for tenure track faculty the services are lighter than tenured ones (e.g., less leadership roles). For example, I have served on the \emph{PhD and/or MS admission committee (adcom)}, \emph{faculty search committee}, and \emph{awards committee} when I was at UNL. Being a member of the PhD adcom is very common for new assistant professors, as it is a good way to recruit students and build your lab. 
