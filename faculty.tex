...
\subsection{Personal Experience} In my case I mostly cold email people for opportunities. For example, I directly email OOPSLA and PLDI PC chairs and asked, and they accepted my request. I tried this with SE conferences  e.g., ICSE (and also nominate myself through the official form), and it never works, even though I have many papers at ICSE. I also got invited to serve on a PC because a senior colleague recommended me.
For NSF, I emailed program managers and asked to serve on their panels.


I felt that I didn't get much out of serving on PCs and didn't really like the review process much. However, I still do it because I feel it is my responsibility, i.e., people spent time reviewing my papers, so I should also volunteer my time to review theirs.
...
Your department chair will assign you to some committees to help run the department.  For tenure-track faculty the services are often lighter than tenured ones (e.g., less leadership roles). Common committees include PhD and/or MS admission, faculty search, and colloquium committees.
...
In most cases, these are optional services and assistant professors often do not take any of them.  Common examples include serving the faculty senate, scholarship committee, etc. The university often sends out emails asking for volunteers (so somewhat generic and you can safely ignore), and sometimes people (e.g., your dept chair or dean) will directly ask you to serve (in which case you will want to consider it).

\subsection{Advice and Personal Experience} I only have limited experience with these services. I served in a couple of grants and scholarship committees, in which I review applications for scholarship and grants for students. I also help represent the college in serving as judge of the KimmyDuong foundation scholarship. These are in general time-consuming (e.g., the KimmyDuong scholarship reviews and interview process happen during weekends!), but they are also rewarding as you get to know students and help them. In general, I would recommend doing these services only if you have the time.  However, sometimes they can be rewarding and fun, so you might want to try them out.
