...
\section{Change in Departmental Leadership. Moving from UNL to GMU}

I joined UNL in 2016 and was very happy there until 2020, which is when the dept. changed its leadership and organization and lead to my decision to be on the job market again.  

I do not want to get into details but below summarizes several things that happened

\begin{itemize}
\item 2019: four senior professors (in SE) left.  One of these 4 had became the chair of the dept and then left just after 2 months.  
\item 2020:  an even split among the faculty on moving to completely to the College of Engr.   Multiple senior people warn about this decision.  The new chair candidate only agrees to accept the job if the faculty moved to CoE, putting pressure on the move.
