...
You will be expected to mentor undergraduate students and graduate students. You will likely need to graduate at least one PhD student to get tenure.
...
\paragraph{PhD Dissertation Committee} Being in a PhD committee is a common task to help your colleagues (e.g., the adviser of the student asks you to be in student dissertation committee) and the students (e.g., you are involved or are interested in the research of the student).  You can serve in the committee of students in your dept, in other dept, or even in a different university (external committee member). This is a good way to build your network (and also help your students build their network).
...
While the renewal is straightforward for most people, it can be surprise and shock to some. Ideally, it should not be a surprise, as your annual evaluation should give you some idea on how you are doing, e.g., if you are not doing well, the annual evaluation should tell you that you need to improve. However, it can be a surprise due to various reasons such as new dept. chair or administrative changes who have different expectations. 
