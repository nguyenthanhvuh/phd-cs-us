...
You are expected to have certain types of services as a faculty member.  While some services are required (e.g., when your department chair assigns you to some committee), some are not and you can decline (e.g., an invitation to be a PC member).  You should be strategic about which services you accept.
...
\subsection{Serving on Program Committees (PC)} You should try to serve on the PC  of the \emph{top} conferences in your field. This is a good way to get to know what is hot in your field, and to get to know people in your field.  It is also a good way to get your name out.

\textbf{Advice}: You can ask senior colleagues or even your PhD advisor/collaborators to recommend you to serve on a PC. You can also directly email the PC chairs and ask to serve on the PC.


\subsection{Serving on NSF Panels} You should serve on NSF panels.  It is a great way to learn about the grant process: how to distinguish between good and bad proposals and how people review proposals.
...
\textbf{Advice}: Similarly to serving in PC, you can cold email program managers in your area and ask to be on a panel. Once you have served, you will likely be invited to serve again.  Unfortunately, I do not have much experience with non-NSF panels or proposals.
...
\subsection{Personal Experience} I have served on many PCs and NSF panels. The initial services are mostly through ``cold'' emails. For example, I directly email OOPSLA and PLDI PC chairs and asked, and they accepted my request (I did have papers at OOPSLA and PLDI when I asked). I tried this with SE conferences  e.g., ICSE (and also nominate myself through the official form), and it never works, even though I have many papers at ICSE.
...
On the otherhand, I throroughly enjoy serving on NSF panels. While the work is more intense and takes more time, I found it more rewarding and enjoy the discussions. Since my first NSF panel in 2019, I have served 7 panels (at least once every year since '19) and I look forward to serving more.
...
\textbf{Advice}: You should try to be strategic about which committees you serve on that can help build your lab and tenure case. For example, serving in the PhD adcom is very common for new assistant professors, as it is a good way to recruit students for your lab. Serving on the faculty search committee is also a good way to recruit new faculty members that you like (and also let you know what the job market is like, just in canse you want to move). Serving on the colloquium committee is also a good way to invite speakers in your field that can be your \emph{tenure letter writers}.

\subsubsection{Personal} Since coming to GMU, I have been much more active in serving the department.  I share the vision of the department and want to help achieve it. In addition to the typical services load, I volunteer to serve in additional committees and leadership roles. For example, I maintain the CSRankings DB for the department, I help organize the Open House to recruit admitted students, I serve in the Dept Chair renewal committee, etc.
Even though I am not on the search committee, I speak to every candidate and help recruit strong ones. I agree to be director of the MS program, which is a lot of work and typically done by tenured faculty.
...
I am also building a good relationship with my colleagues and the department chair, and that is important for my tenure case.
In addition, I learn a lot from being in various roles (e.g., I learned how class scheduling work, how the deparmtnet is run, how to recruit students, how to recruit faculty, how to run a colloquium, etc) and feel more confident in my leadership skills.

In short, if you are enthusiastic about the department, want to make a difference, and \emph{feel comfortable at handling additional load}, you can volunteer for more services and leadership roles.
