...
\subsection{Tenure Visits and Colloqium} Close to the tenure application (e.g., during the Spring), some tenure candidates will visit other universities to give talks and meet people. 
...
These are all good ways to get your name out and to get letters.
The traditional way is a physical visit, but since the pandemic, many of these visits are done remotely (which are more convenient for many people).

I did not do any tenure visits or host anyone for the purpose of getting tenure letters. This was partly because I am not a travel person, and also I felt that it would not help much in my case; I believe that I have strong record and very good relationship with my colleagues and the dept.  Instead, during the Spring'23 semester before my tenure application, I put lots of effort in helping the university in recruiting faculty (by meeting with 20+ faculty candidates), even though I am not in the search committee and really didn't have service requirements as I am on study break that semester.  As mentioned in \autoref{sec:services-dept}, I didn't really do any of these for my tenure case, but because I enjoy the working env at GMU and want to help out.
