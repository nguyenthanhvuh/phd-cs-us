...
\subsection{Letters}
You will need letters from senior people in your area.  Someone who can vouch for you.
You will need 4--6 letters. However, you will not be the one asking for these letters, but your department will. You can suggest who to ask.  This process doesn't take much of your time (because you don't write the letters) but it might cause you a lot of stress (because you don't have full control over it).
...
In my case I put just 2 names in my list (0 on blacklist) and let the department decide the rest. The reason that I only put 2 names is that I feel I don't have too many "enemies" out there that would write bad things about me.  Those that don't know me well will likely just decline the letter invitation.  This also gives the department more choices on their list.
Note I also thought about leaving my list empty, but then that seems to be too weird, and I don't want to give the impression that I don't have any "friends" in academic. 

The department selected 1 of the 2 names on my list and 4 more names from the department's list. Moreover, it appears that no one declines so my letter writers are all set fairly quickly in the process. All of my letters were very good and give many positive comments about me as summarized in my evaluation letter (sent to me after the tenure decision).  I will never know who wrote the letters, but I am very grateful to them.

\subsection{Tenure Talk}
After you submit your tenure package, you might be asked to give a tenure talk.  This is a talk where you summarize your research, teaching, and services, and future plans.  The talk is typically 1 hour long, and there will be a Q\&A session afterward.  The talk is open to the public.

\subsection{Others}

\paragraph{Tenure Visits} Many people will visit other universities to give talks and meet people.  This is a good way to get your name out and to get letters (e.g., from the person that host you).  Physical visits were not possible during the pandemic, but virtual visits are possible and in fact easier. However,  I did not do any tenure visits or give talks in the year leading up to my tenure application. This was because I am not a travel person and also I felt that it would not help much in my case.
