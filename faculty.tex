...
This section focuses on paper publication, which is a major component of P\&T and of course in getting your name out there. P\&T evaluation requires no specific conferences/journals or numbers of papers, but typically you will want to have a good number of papers in top venues. P\&T members or letter writers (obviously) are familiar with top places in your field, and they will definitely look for those in your profile.
Work that won awards, e.g., paper awards, can help a lot in tenure evaluation. Papers with very high citations also help.  Research areas that you started and are now popular also count.  Finally, new research directions that can help get grants are also good.

\section{Venues}

Depending on your research area, you might focus on publishing at top conferences or journals.  You probably should know what's popular in your area already (if not, ask your senior colleagues). If you're at an R1 university, you will want to publish at top venues, and not just any venue.  You should also aim to publish at a variety of venues, and not just one.  This will show that your research is of interest to a wide range of people.

\paragraph{Conferences}
In most CS fields, top conferences are more common and competitive than journals. Each field also has several of such top conferences yearly (e.g., in Software Engineering, ICSE, FSE, ASE, and ISSTA are top four).  They are often scheduled so that if you miss (or get rejected) from one, you can submit to another. 
...
\paragraph{Journals}
In some journals are more common and prestigious. Moreover, many areas have top journals in additions to well-known conferences (e.g., Trans. of Software Engr. or TSE is a very well-known journal in Software Engineering, which has 4 major confs.).  Typically, or at least in SE, the common approach is publishing new work to conference and followup work to journals (e.g., so the journal paper is an substantial extension of the conf. paper with new experiments, studies, theorems, etc). In some sense, journals are for more mature work, and conferences are for new ideas. 

\paragraph{Short papers, workshops, etc}



\section{Collaboration and co-authorship}
While it's general true that profs. are busy, but for me and probably many others, it's not the main reason.  I do skim every single emails from prospective students, but I ignore most of them because they were quite generic (likely written for dozen of other profs.).  Sometimes they try to "customize" it by mentioning the names of my papers, but the contents are still quite irrelevant.  So even if I am not busy (e.g.,  spending time on reddit), I still would not reply to such emails. 

For the OP: you can follow up with an email now since it has been almost a month,  or do it later.  I wouldn't care if you send now or later --  if it's generic I'll ignore it,  but if it is personalized and especially relevant to my work, I'll likely reply.  If I am not, then you can assume I am not the right fit and should move on.  




\paragraph{Papers with your adviser(s)}
