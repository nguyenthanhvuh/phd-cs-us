...
Toward the end of your 3rd year (or early 4th year), you will need to submit a \emph{renewal} application.  The department will then review your application and vote on whether to renew you for your 4th (and perhaps also 5th year). At some university this renewal is almost guaranteed, but at some other universities, it is not and people do get denied. 
...
Here is my \href{https://dynaroars.github.io/people/nguyenthanhvuh/files/pt/slides.pdf}{talk}. I focus on my recent research direction on neural network verification and just briefly on my past work. Overall, I didn't have to spend too much time on preparing because I reused slides from my job and research talk and just added at the end a ``stats'' slide on my funding, pubs, teaching, services, etc. 


\subsection{Your ``Champion'' in the P\&T Meeting}

You will need a senior faculty member (or ``champion'') from your department to present your case in the department P\&T meeting. This person will present your achievements and argue for you.  Typically, this person is your mentor, but it can be anyone in the department that you trust and who knows your work well.
