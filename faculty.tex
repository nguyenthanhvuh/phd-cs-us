...
While it's general true that profs. are busy, but for me and probably many others, it's not the main reason.  I do skim every single emails from prospective students, but I ignore most of them because they were quite generic (likely written for dozen of other profs.).  Sometimes they try to "customize" it by mentioning the names of my papers, but 

.  So even if I am not busy (e.g., spending time on reddit), I still would not reply to such emails.  
